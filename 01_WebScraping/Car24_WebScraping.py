...
page_number_end = int(input('''Enter End Number Page (at July, 2023 end number is 1821 pages): ''')) #End page last page at 1774
...
#url_page = input('''Enter URL Enter: ''')
url_page = 'https://www.cars24.co.th/buy-used-cars-bangkok/'
while True:
